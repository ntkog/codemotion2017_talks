...
function summary(arr, params = {}) {
  ...
  let [terms_spa, terms_eng] = [
     tm.DocumentTermMatrix(corpus_spa).removeSparseTerms( SPARSE_PERCENT ),
     tm.DocumentTermMatrix(corpus_eng).removeSparseTerms( SPARSE_PERCENT )
   ];
